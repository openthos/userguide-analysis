...
2. [下载OPENTHOS镜像](一.安装.md#openthos镜像下载)     
3. 制作U盘启动盘    
...
1. [下载OPENTHOS镜像](一.安装.md#openthos镜像下载)   
2. 制作OPENTHOS的安装U盘    
...
![](./pic/anzhuang/bootOption1.jpg)  

OPENTHOS有多种启动方式,可在U盘启动的图标下按F2键进入菜单，如下图所示:

![](./pic/anzhuang/UEFI.jpg)  
     
![](./pic/anzhuang/InstallOption.jpg)  
...
要求:对U盘的安装要求比较高,否则容易出现卡顿现象  
   ...
   - 3.OpenThos Installation：普通安装模式(**推荐**)
      ...
      - 普通安装模式包括[自动安装](一.安装.md#自动安装)和[手动安装](一.安装.md#手动安装)，具体操作如下：
...
![](./pic/anzhuang/chooseharddrive.jpg)
...
- 2.开始安装     
 ...
 ![](pic/anzhuang/manual_efi.jpg)

 格式化EFI分区（**如果还有其它系统，且引导安装在该分区可以选择第一项不格式化**）

 ![](pic/anzhuang/manual_fat32.jpg)   
 ![](pic/anzhuang/confirm1.jpg)   
 ![](pic/anzhuang/confirm2.jpg)   

 选择system存放分区

 ![](pic/anzhuang/manual_system.jpg)

 格式化

 ![](pic/anzhuang/manual_ext4.jpg)

 选择data存放分区

 ![](pic/anzhuang/manual_data.jpg)

 格式化

 ![](pic/anzhuang/manual_ext4_2.jpg)

 OPENTHOS oto_img版本安装完成后系统会自动重启，选择相应的boot选项可进入openthos启动引导界面。

 ![](pic/anzhuang/openthosBoot.jpg)  
