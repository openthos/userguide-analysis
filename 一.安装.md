...
![](pic/anzhuang/pic/2.png)
 2.为OPENTHOS预留3个分区（此处为/dev/sda3 /dev/sda11 /dev/sda12）  
![](pic/anzhuang/pic/3.png)
![](pic/anzhuang/pic/4.png)
![](pic/anzhuang/pic/5.png)
...
![](pic/anzhuang/pic/6.JPG)

三.开始安装
  选择OTO install（Normal install）
![](pic/anzhuang/pic/7.JPG)
  选择手动安装，否则会格式化掉整个硬盘
![](pic/anzhuang/pic/8.JPG)
  依次选择曾经分好的3个分区，先选择EFI分区
![](pic/anzhuang/pic/9.JPG)
  格式化EFI分区（如果还有其它系统，且引导安装在该分区可以选择第一项不格式化）
![](pic/anzhuang/pic/10.JPG)
  选择system存放分区
![](pic/anzhuang/pic/11.JPG)
  格式化
![](pic/anzhuang/pic/12.JPG)
  选择dataimg存放分区
![](pic/anzhuang/pic/13.JPG)
  格式化
![](pic/anzhuang/pic/14.JPG)
![](pic/anzhuang/pic/15.JPG)
![](pic/anzhuang/pic/16.JPG)
