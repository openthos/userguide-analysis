# 系统设置(展示图)  
![](pic/xitongshezhi/setting_zhenggejiemian.png)
...
## 一. 无线和网络
   ...
   - 蓝牙
   ![](pic/xitongshezhi/setting_bluetooth.png)    
      - 右上角 菜单键 （三个点图标）
        - 刷新
        - 重命名此设备
...
## 四. 系统
   ...
   - ![](pic/xitongshezhi/tmp_9632-settingkaifa-1862915064.png)
      - 开启
        ...
        - 关闭 
          ...
          - 超级用户
   - 关于设备
   - ![](pic/xitongshezhi/setting-guanyushebei1.png)
   - ![](pic/xitongshezhi/setting-guanyushebei2.png)
     - 系统重置 (功能可用)
     - 系统升级配置
     - 系统升级 
     - 法律信息
   ...
   - ![](pic/xitongshezhi/tmp_9632-settingcloud914066040.png)
     - 云服务可以同步的数据
       ...
       - 邮箱          
       - 应用数据（暂时不支持此数据同步）       
       - 开始菜单（暂时只支持同步锁定到任务栏的应用）       
       - 浏览器         
       - 应用商店（暂时不支持此数据同步）       
     - 导出      （把需要同步的数据导出到云服务中）

     - 导入      （把云服务中的数据同步到本地电脑上）
     - [文件管理器云服务关联介绍](soft/点此查看云服务.md)
